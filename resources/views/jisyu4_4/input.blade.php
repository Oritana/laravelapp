...
@section('content')
   ...
   @endif
   <table>
   <form action="/jisyu9" method="post">
       @csrf
       ...
       @endif
       <tr><th>住　　　所: </th><td><input type="text" name="address" value="{{$data['address']}}" size="40"></td></tr>
       <tr><th></th><td>※必須項目。20文字以内。</td></tr>
       @if ($errors->has('address'))
       <tr><th></th><td><font color="red">{{$errors->first('address')}}</font></td></tr>
       @endif
